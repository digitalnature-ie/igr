...
Convert Irish grid references to Irish Grid ([EPSG:29903](https://epsg.io/29903)) coordinates or a collection of simple features in an sf object, and vice versa.

All resolutions of Irish grid references are supported, from 100 km (e.g. "N") to 1 m (e.g. "N 87685 27487"). 

Irish grid references can be converted into point or polygon [sf](https://r-spatial.github.io/sf/) (simple features) objects in any coordinate reference system.
