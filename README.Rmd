...
The very helpful 2nd edition of ["R Packages" by Hadley Wickham and Jennifer Bryan](https://r-pkgs.org/) was consulted extensively during development. The code is implemented using base R where possible to minimise package dependencies, and adopts the [tidyverse coding style](https://style.tidyverse.org/).
