...
```{r example-igr-points, message=FALSE, echo=FALSE, eval=plot_maps, fig.alt="A map of Ireland with a dot at the south-west corner of each sample grid reference."}
library(maps)
library(tmap)
...
```{r example-igr-polygons, message=FALSE, echo=FALSE, eval=plot_maps, fig.alt="A map of Ireland with polygons spanning each sample grid reference. The polygons range in size from 100 km square to 1 m square."}
